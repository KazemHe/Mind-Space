      ...
      <div className='table-of-contents' dir='rtl'>
        <div className='thesis-content'>
          ...
          <Link to='/thesis/page/2' className='custom-link'>
            <h4>פרק 1 : מבוא ורקע............2</h4>
          </Link>
          <Link to='/thesis/page/3' className='custom-link'>
            <p>1.1 הבנת משבר בריאות הנפש והפוטנציאל של מציאות מדומה</p>
          </Link>
          <Link to='/thesis/page/4' className='custom-link'>
            <p>1.2 מתודולוגיה: יצירת מסע לשינוי פרדיגמה</p>
          </Link>
          <Link to='/thesis/page/5' className='custom-link'>
            <p>1.3 תחום ומגבלות</p>
          </Link>
          ...
          <Link to='/thesis/page/8' className='custom-link'>
            <p>2.1 אתגרי בריאות הנפש: חקר עומק המשבר</p>
          </Link>
          <Link to='/thesis/page/9' className='custom-link'>
            <p>2.2 גישות טיפוליות: למידה מהמסורת ומההווה</p>
          </Link>
          <Link to='/thesis/page/10' className='custom-link'>
            <p>2.3 אסטרטגיות לניהול עצמי עם הפרעות נפשיות</p>
          </Link>
          <Link to='/thesis/page/11' className='custom-link'>
            <p>2.4 אלכימיה אדריכלית: האיחוד בין עיצוב לרווחת הנפש</p>
          </Link>
          <Link to='/thesis/page/12' className='custom-link'>
            <p>2.5 כניסה לתחום הוירטואלי: הכוח הטרנספורמטיבי של טיפול בVR</p>
          </Link>
          <Link to='/thesis/page/13' className='custom-link'>
            <h4>פרק 3: יסודות תיאורטיים</h4>
          </Link>
          <Link to='/thesis/page/14' className='custom-link'>
            <p>3.1 אודיסאה אתית: ניווט בשטח המוסרי של מרחבים טיפוליים וירטואליים</p>
          </Link>
          <Link to='/thesis/page/15' className='custom-link'>
            <p>3.2 עיצוב העתיד: עיצוב מסתגל למסעות הנפש</p>
          </Link>
          <Link to='/thesis/page/16' className='custom-link'>
            <p>3.3 חיבוק הטבע: האפקט המרפא של עיצוב ביופילי</p>
          </Link>
          <Link to='/thesis/page/17' className='custom-link'>
            <p>3.4 עיצוב להכלה: קידום נגישות ושוויון במרחבים טיפוליים וירטואליים</p>
          </Link>
          <Link to='/thesis/page/18' className='custom-link'>
            <p>3.5 לעמוד על כתפי נפילים: השראות אדריכליות</p>
          </Link>
        </div>
        <div className='thesis-content'>
          ...
          <Link to='/thesis/page/20' className='custom-link'>
            <p>4.1 פרויקט "מיינדספייס"</p>
          </Link>
          <Link to='/thesis/page/21' className='custom-link'>
            <p>4.2 שיקולי עיצוב ממשק משתמש והדרכה למסע</p>
          </Link>
          <Link to='/thesis/page/22' className='custom-link'>
            <p>4.3 קשיבות: יצירת שלווה במרכז המיינדפולנס</p>
          </Link>
          <Link to='/thesis/page/23' className='custom-link'>
            <p>4.4 נשימה: מסע השינוי האישי במרכז הריברסינג</p>
          </Link>
          <Link to='/thesis/page/24' className='custom-link'>
            <p>4.5 תחושה: קידום הרפיה ומודעות עצמית במרכז לטיפול חושי</p>
          </Link>
